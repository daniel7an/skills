...
description: Strip a problem down to physical, mathematical and raw-material truths, compute the theoretical floor, and rebuild the solution from there. Use for design, architecture, invention, optimization, cost, efficiency or scalability questions, for "how should we...", "what is the best way...", "is X possible", and whenever an industry norm, a best practice, or an accepted price is being treated as fixed.
---
...
**SpaceX rockets**
Industry price is about $65 million.
First-principles decomposition:
What is a rocket made of? Aerospace-grade aluminum alloys, titanium, copper, carbon fiber.
Commodity market value of those materials is about 2 % of the finished rocket price.
...
London Metal Exchange spot prices summed to about $80/kWh.
